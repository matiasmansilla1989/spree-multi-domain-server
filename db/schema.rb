...
ActiveRecord::Schema.define(version: 20150330192803) do
  ...
  add_index "spree_option_types", ["store_id"], name: "index_spree_option_types_on_store_id"
  ...
  add_index "spree_products", ["store_id"], name: "index_spree_products_on_store_id"
  ...
  add_index "spree_properties", ["store_id"], name: "index_spree_properties_on_store_id"
  ...
  add_index "spree_prototypes", ["store_id"], name: "index_spree_prototypes_on_store_id"
  ...
  add_index "spree_shipping_categories", ["store_id"], name: "index_spree_shipping_categories_on_store_id"
  ...
  add_index "spree_shipping_methods", ["store_id"], name: "index_spree_shipping_methods_on_store_id"
  ...
  add_index "spree_stores", ["user_id"], name: "index_spree_stores_on_user_id"
  ...
  add_index "spree_taxonomies", ["user_id"], name: "index_spree_taxonomies_on_user_id"
  ...
  add_index "spree_taxons", ["store_id"], name: "index_spree_taxons_on_store_id"
  add_index "spree_taxons", ["taxonomy_id"], name: "index_taxons_on_taxonomy_id"
  add_index "spree_taxons", ["user_id"], name: "index_spree_taxons_on_user_id"
  ...
  add_index "spree_users", ["store_customer_id"], name: "index_spree_users_on_store_customer_id"
  add_index "spree_users", ["store_id"], name: "index_spree_users_on_store_id"
